...
#test
board = {0: ['purple', 'purple', 'purple', 'yellow', 'green', 'purple', 'purple', 'purple'], 1: ['red', 'red', 'yellow', 'blue', 'purple', 'red', 'purple', 'orange'], 2: ['red', 'orange', 'green', 'purple', 'red', 'green', 'purple', 'blue'], 3: ['green', 'red', 'purple', 'red', 'red', 'red', 'purple', 'red'], 4: ['blue', 'green', 'red', 'green', 'purple', 'blue', 'purple', 'orange'], 5: ['green', 'green', 'green', 'blue', 'green', 'green', 'green', 'green'], 6: ['yellow', 'green', 'green', 'purple', 'green', 'purple', 'purple', 'orange'], 7: ['red', 'green', 'red', 'orange', 'orange', 'red', 'purple', 'red']}
...
def collapseItems(board, columnDict, rowDict):
    # remove the items from the rows
    # add to counter
    # move all items down
    # load new items

    #start W horiz, go to vertical
...
# - need to compare the different things
# - cycle through each thing then compare the numbers eg. 0, 1, 2, 3 etc
    ...
    for colKey in columnDict:
        ...
        while j<colLen:
            print(columnDict[colKey][1])
            # print(columnDict[colKey][1][i])
        ...
        # print(columnDict[colKey][0])
        # print("    ")

        # i = 0
        # while i < colLen - 4:
        #     if len(columnDict[colKey][0][i]) + len(columnDict[colKey][0][i+1])




        # print(len(columnDict[colKey][1]))
        # print("kddf")
    ...
    for item in itemTypes:
        for r in range(ROW_COUNT):
            ...
            if len(comboColumns) > 0:
                ...
                print(str(comboColumns) + " " + " horizontal " + str(item))
        ...
        for c in range(COLUMN_COUNT):
            ...
            if len(comboRows) > 0:
                ...
                print(str(comboRows) + " " + " vertical " + str(item))

            comboRows = []
            rowMarker = 0

    print(columnComboDict)
    #columns down


    print(rowComboDict)
    collapseItems(board, columnComboDict, rowComboDict)
